...
# 2027-03-01 · Day 182 · 把业务需求划分为问题类型

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../07-第7月-高级RAG与评测.md)

[上一天：冻结 V1 基线](../../2027-02/2027-02-28-Day181-冻结-V1-基线/README.md) · [下一天：设计评测集数据结构](../2027-03-02-Day183-设计评测集数据结构/README.md)

## 今日定位

- **日期**：2027-03-01（星期一）
- **阶段**：第 7 月 / 模块内第 2 天 / 全年第 182 天
- **分类**：高级RAG与评测
- **难度**：进阶
- **原计划时间**：1.5～2 小时。
...
事实题、操作步骤题、同义表达、版本题、表格题、多证据题、无答案题和权限题；高风险问题应单独标记。

### 概念自检

- [ ] 能用自己的话解释：事实题、操作步骤题、同义表达、版本题、表格题、多证据题、无答案题和权限题
- [ ] 能用自己的话解释：高风险问题应单独标记
...
回看需求、FAQ、搜索日志或模拟用户提问，建立问题分类表；为每类写出典型输入、预期数据源、失败风险和是否允许拒答。
...
完成至少 8 类问题的测试矩阵；每类有定义、示例和验收重点，合计规划为 100 条。
...
- 分支：`study/day-182`
- 建议提交：`study(day-182): 把业务需求划分为问题类型`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：设计评测集数据结构](../2027-03-02-Day183-设计评测集数据结构/README.md)
