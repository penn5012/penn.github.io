...
# 2027-04-23 · Day 235 · 图级集成测试

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../08-第8月-LangGraph工作流.md)

[上一天：节点单元测试](../2027-04-22-Day234-节点单元测试/README.md) · [下一天：Trace、日志与审计](../2027-04-24-Day236-Trace-日志与审计/README.md)

## 今日定位

- **日期**：2027-04-23（星期五）
- **阶段**：第 8 月 / 模块内第 25 天 / 全年第 235 天
- **分类**：LangGraph工作流
- **难度**：进阶
- **原计划时间**：2～2.5 小时。
...
测试 Checkpointer、场景夹具、状态快照、端到端与集成测试边界；确定性回放。

### 概念自检

- [ ] 能用自己的话解释：测试 Checkpointer、场景夹具、状态快照、端到端与集成测试边界
- [ ] 能用自己的话解释：确定性回放
...
编写至少 8 条流程测试：直接解决、需要澄清、无证据、高风险审批通过/拒绝、建单超时、通知失败、重复恢复。
...
8 条流程均验证最终状态和节点路径；外部服务全部可替换为测试双；失败场景不会产生重复工单。
...
- 分支：`study/day-235`
- 建议提交：`study(day-235): 图级集成测试`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：Trace、日志与审计](../2027-04-24-Day236-Trace-日志与审计/README.md)
