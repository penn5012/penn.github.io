...
# 2027-04-03 · Day 215 · 条件分支与路由函数

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../08-第8月-LangGraph工作流.md)

[上一天：编写可测试的节点](../2027-04-02-Day214-编写可测试的节点/README.md) · [下一天：澄清信息与有限循环](../2027-04-04-Day216-澄清信息与有限循环/README.md)

## 今日定位

- **日期**：2027-04-03（星期六）
- **阶段**：第 8 月 / 模块内第 5 天 / 全年第 215 天
- **分类**：LangGraph工作流
- **难度**：进阶
- **原计划时间**：2 小时。
...
Conditional Edge、路由函数、枚举结果、默认分支；业务规则优先于模型自由路由；未知分类的安全降级。

### 概念自检

- [ ] 能用自己的话解释：Conditional Edge、路由函数、枚举结果、默认分支
- [ ] 能用自己的话解释：业务规则优先于模型自由路由
- [ ] 能用自己的话解释：未知分类的安全降级
...
在分类后增加路由：常见咨询进入 RAG，信息不足进入澄清，高风险投诉直接进入人工处理，未知类别进入兜底。
...
为四条分支各写一个测试；路由函数不调用外部 API；任何输入都有可预测出口。
...
- 分支：`study/day-215`
- 建议提交：`study(day-215): 条件分支与路由函数`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：澄清信息与有限循环](../2027-04-04-Day216-澄清信息与有限循环/README.md)
