...
# 2027-03-26 · Day 228 · 补偿与部分失败处理

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../08-第8月-LangGraph工作流.md)

[上一天：幂等地创建工单](../2027-03-25-Day227-幂等地创建工单/README.md) · [下一天：风险判断与人工审批](../2027-03-27-Day229-风险判断与人工审批/README.md)

## 今日定位

- **日期**：2027-03-26（星期五）
- **阶段**：第 8 月 / 模块内第 18 天 / 全年第 228 天
- **分类**：LangGraph工作流
- **难度**：进阶
- **原计划时间**：2 小时。
...
补偿动作、Saga 思想、最终一致性、可重放任务；哪些操作能撤销，哪些只能追加纠正记录。

### 概念自检

- [ ] 能用自己的话解释：补偿动作、Saga 思想、最终一致性、可重放任务
- [ ] 能用自己的话解释：哪些操作能撤销，哪些只能追加纠正记录
...
设计副作用表；通知失败时保留工单并进入待补发队列，而不是删除工单；如创建了临时资源，则提供安全取消动作。
...
写出补偿矩阵；模拟通知连续失败，工单状态仍一致且可稍后补发；补偿动作自身也具备幂等性。
...
- 分支：`study/day-228`
- 建议提交：`study(day-228): 补偿与部分失败处理`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：风险判断与人工审批](../2027-03-27-Day229-风险判断与人工审批/README.md)
