...
# 2026-12-24 · Day 136 · 编写受证据约束的回答提示词

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../05-第5月-Dify知识库入门.md)

[上一天：在 Chatflow 中接入知识检索](../2026-12-23-Day135-在-Chatflow-中接入知识检索/README.md) · [下一天：实现引用与来源展示](../2026-12-25-Day137-实现引用与来源展示/README.md)

## 今日定位

- **日期**：2026-12-24（星期四）
- **阶段**：第 5 月 / 模块内第 16 天 / 全年第 136 天
- **分类**：Dify知识库
- **难度**：基础工程
- **原计划时间**：1.5～2 小时。
...
角色、任务、证据范围、输出格式、拒答条件、冲突信息处理、避免暴露内部提示词。

### 概念自检

- [ ] 能用自己的话解释：角色、任务、证据范围、输出格式、拒答条件、冲突信息处理、避免暴露内部提示词
...
写一版回答 Prompt，要求仅依据检索内容回答、区分事实与建议、证据不足时说明缺失信息。
...
完成 Prompt v1；用 5 个有答案问题和 5 个无答案问题测试，无答案问题不会强行编造具体结论。
...
- 分支：`study/day-136`
- 建议提交：`study(day-136): 编写受证据约束的回答提示词`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：实现引用与来源展示](../2026-12-25-Day137-实现引用与来源展示/README.md)
