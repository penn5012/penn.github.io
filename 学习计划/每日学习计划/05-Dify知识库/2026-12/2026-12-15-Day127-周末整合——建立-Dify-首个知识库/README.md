...
# 2026-12-15 · Day 127 · 周末整合——建立 Dify 首个知识库

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../05-第5月-Dify知识库入门.md)

[上一天：理解 RAG 全链路](../2026-12-14-Day126-理解-RAG-全链路/README.md) · [下一天：理解分段为什么影响检索](../2026-12-16-Day128-理解分段为什么影响检索/README.md)

## 今日定位

- **日期**：2026-12-15（星期二）
- **阶段**：第 5 月 / 模块内第 7 天 / 全年第 127 天
- **分类**：Dify知识库
- **难度**：基础工程
- **原计划时间**：2.5 小时。
...
Dify 数据集/知识库、文档导入、索引模式、分段预览、召回测试。

### 概念自检

- [ ] 能用自己的话解释：Dify 数据集/知识库、文档导入、索引模式、分段预览、召回测试
...
创建知识库，导入第一批清洗文档；检查分段预览，使用第 1 天的问题进行检索测试。
...
知识库可用；保存配置与 5 个检索测试截图，至少 3 个问题能召回正确文档片段；写出第一次失败观察。
...
- 分支：`study/day-127`
- 建议提交：`study(day-127): 周末整合——建立-Dify-首个知识库`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：理解分段为什么影响检索](../2026-12-16-Day128-理解分段为什么影响检索/README.md)
