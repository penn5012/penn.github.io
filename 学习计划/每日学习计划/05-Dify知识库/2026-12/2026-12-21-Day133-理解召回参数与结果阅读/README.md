...
# 2026-12-21 · Day 133 · 理解召回参数与结果阅读

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../05-第5月-Dify知识库入门.md)

[上一天：补齐元数据并验证过滤](../2026-12-20-Day132-补齐元数据并验证过滤/README.md) · [下一天：周末整合——知识库基线版本](../2026-12-22-Day134-周末整合——知识库基线版本/README.md)

## 今日定位

- **日期**：2026-12-21（星期一）
- **阶段**：第 5 月 / 模块内第 13 天 / 全年第 133 天
- **分类**：Dify知识库
- **难度**：基础工程
- **原计划时间**：2 小时。
...
Top-K、相似度阈值、召回不足、噪声召回、结果去重；参数之间的基本权衡。

### 概念自检

- [ ] 能用自己的话解释：Top-K、相似度阈值、召回不足、噪声召回、结果去重
- [ ] 能用自己的话解释：参数之间的基本权衡
...
使用明确问题、模糊问题、口语问题、错误型号问题分别测试不同 Top-K/阈值设置。
...
形成参数实验记录，至少 12 次测试；选出一组当前基线配置并说明原因。
...
- 分支：`study/day-133`
- 建议提交：`study(day-133): 理解召回参数与结果阅读`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：周末整合——知识库基线版本](../2026-12-22-Day134-周末整合——知识库基线版本/README.md)
