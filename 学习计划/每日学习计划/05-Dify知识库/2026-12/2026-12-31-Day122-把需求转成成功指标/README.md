...
# 2026-12-31 · Day 122 · 把需求转成成功指标

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../05-第5月-Dify知识库入门.md)

[上一天：明确场景与用户边界](../2026-12-30-Day121-明确场景与用户边界/README.md) · [下一天：盘点数据源](../../2027-01/2027-01-01-Day123-盘点数据源/README.md)

## 今日定位

- **日期**：2026-12-31（星期四）
- **阶段**：第 5 月 / 模块内第 2 天 / 全年第 122 天
- **分类**：Dify知识库
- **难度**：基础工程
- **原计划时间**：1.5～2 小时。
...
业务指标与技术指标的区别；正确率、引用正确率、无依据回答率、响应时间、问题解决率、用户反馈率。

### 概念自检

- [ ] 能用自己的话解释：业务指标与技术指标的区别
- [ ] 能用自己的话解释：正确率、引用正确率、无依据回答率、响应时间、问题解决率、用户反馈率
...
为助手定义上线前门槛，区分关键问题、普通问题和超范围问题；设计人工兜底规则。
...
完成指标表，至少定义 6 个指标、计算方法、目标值和数据来源；明确 3 类失败样例。
...
- 分支：`study/day-122`
- 建议提交：`study(day-122): 把需求转成成功指标`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：盘点数据源](../../2027-01/2027-01-01-Day123-盘点数据源/README.md)
