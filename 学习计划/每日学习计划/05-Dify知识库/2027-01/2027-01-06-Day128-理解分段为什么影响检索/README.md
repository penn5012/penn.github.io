...
# 2027-01-06 · Day 128 · 理解分段为什么影响检索

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../05-第5月-Dify知识库入门.md)

[上一天：周末整合——建立 Dify 首个知识库](../2027-01-05-Day127-周末整合——建立-Dify-首个知识库/README.md) · [下一天：执行分段对照实验](../2027-01-07-Day129-执行分段对照实验/README.md)

## 今日定位

- **日期**：2027-01-06（星期三）
- **阶段**：第 5 月 / 模块内第 8 天 / 全年第 128 天
- **分类**：Dify知识库
- **难度**：基础工程
- **原计划时间**：1.5～2 小时。
...
Chunk 粒度、重叠、上下文完整性、标题丢失、一个分段只表达一个主题、父子段思想。

### 概念自检

- [ ] 能用自己的话解释：Chunk 粒度、重叠、上下文完整性、标题丢失、一个分段只表达一个主题、父子段思想
...
选择同一份文档，设计“小段、中段、按章节”三种策略，并预测它们对 10 个问题的影响。
...
完成分段实验设计表，包含策略、适用文档、优点、风险和预期结果。
...
- 分支：`study/day-128`
- 建议提交：`study(day-128): 理解分段为什么影响检索`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：执行分段对照实验](../2027-01-07-Day129-执行分段对照实验/README.md)
