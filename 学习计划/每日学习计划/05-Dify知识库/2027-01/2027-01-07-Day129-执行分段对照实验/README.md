...
# 2027-01-07 · Day 129 · 执行分段对照实验

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../05-第5月-Dify知识库入门.md)

[上一天：理解分段为什么影响检索](../2027-01-06-Day128-理解分段为什么影响检索/README.md) · [下一天：理解索引与 Embedding 的工程意义](../2027-01-08-Day130-理解索引与-Embedding-的工程意义/README.md)

## 今日定位

- **日期**：2027-01-07（星期四）
- **阶段**：第 5 月 / 模块内第 9 天 / 全年第 129 天
- **分类**：Dify知识库
- **难度**：基础工程
- **原计划时间**：2～2.5 小时。
...
检索结果的相关性、完整性、冗余度；Top-K 结果观察。

### 概念自检

- [ ] 能用自己的话解释：检索结果的相关性、完整性、冗余度
- [ ] 能用自己的话解释：Top-K 结果观察
...
将同一文档按三种策略导入测试知识库，对同一组 10 个问题执行召回测试并记录首条命中情况。
...
完成分段对照表；为主文档选出默认策略，并写明至少 3 条证据。
...
- 分支：`study/day-129`
- 建议提交：`study(day-129): 执行分段对照实验`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：理解索引与 Embedding 的工程意义](../2027-01-08-Day130-理解索引与-Embedding-的工程意义/README.md)
