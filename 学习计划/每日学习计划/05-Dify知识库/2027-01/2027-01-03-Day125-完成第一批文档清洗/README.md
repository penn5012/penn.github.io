...
# 2027-01-03 · Day 125 · 完成第一批文档清洗

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../05-第5月-Dify知识库入门.md)

[上一天：识别脏数据与权限风险](../2027-01-02-Day124-识别脏数据与权限风险/README.md) · [下一天：理解 RAG 全链路](../2027-01-04-Day126-理解-RAG-全链路/README.md)

## 今日定位

- **日期**：2027-01-03（星期日）
- **阶段**：第 5 月 / 模块内第 5 天 / 全年第 125 天
- **分类**：Dify知识库
- **难度**：基础工程
- **原计划时间**：2～2.5 小时。
...
标题层级、段落边界、列表、表格转写、图片说明、代码块、页眉页脚去除。

### 概念自检

- [ ] 能用自己的话解释：标题层级、段落边界、列表、表格转写、图片说明、代码块、页眉页脚去除
...
清洗 3～5 份代表性文档，优先转为 Markdown；保留章节标题、产品型号和版本信息。
...
得到第一批 `docs/cleaned/` 文件；随机检查 10 个段落，内容完整、无明显页眉页脚噪声、标题层级正确。
...
- 分支：`study/day-125`
- 建议提交：`study(day-125): 完成第一批文档清洗`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：理解 RAG 全链路](../2027-01-04-Day126-理解-RAG-全链路/README.md)
