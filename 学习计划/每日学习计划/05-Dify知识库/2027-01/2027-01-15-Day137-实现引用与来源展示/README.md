...
# 2027-01-15 · Day 137 · 实现引用与来源展示

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../05-第5月-Dify知识库入门.md)

[上一天：编写受证据约束的回答提示词](../2027-01-14-Day136-编写受证据约束的回答提示词/README.md) · [下一天：实现问题澄清分支](../2027-01-16-Day138-实现问题澄清分支/README.md)

## 今日定位

- **日期**：2027-01-15（星期五）
- **阶段**：第 5 月 / 模块内第 17 天 / 全年第 137 天
- **分类**：Dify知识库
- **难度**：基础工程
- **原计划时间**：2 小时。
...
引用的文档名、章节、片段、链接；引用完整性和引用相关性。

### 概念自检

- [ ] 能用自己的话解释：引用的文档名、章节、片段、链接
- [ ] 能用自己的话解释：引用完整性和引用相关性
...
配置回答中的来源/引用；设计客户端引用卡片字段，包括文档名、章节、摘要和展开入口。
...
至少 10 个回答显示可识别来源；抽查每条引用确实支持对应结论，不只是在同一文档中出现。
...
- 分支：`study/day-137`
- 建议提交：`study(day-137): 实现引用与来源展示`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：实现问题澄清分支](../2027-01-16-Day138-实现问题澄清分支/README.md)
