...
# 2027-01-13 · Day 135 · 在 Chatflow 中接入知识检索

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../05-第5月-Dify知识库入门.md)

[上一天：周末整合——知识库基线版本](../2027-01-12-Day134-周末整合——知识库基线版本/README.md) · [下一天：编写受证据约束的回答提示词](../2027-01-14-Day136-编写受证据约束的回答提示词/README.md)

## 今日定位

- **日期**：2027-01-13（星期三）
- **阶段**：第 5 月 / 模块内第 15 天 / 全年第 135 天
- **分类**：Dify知识库
- **难度**：基础工程
- **原计划时间**：2 小时。
...
开始节点、用户输入、知识检索节点、LLM 节点、回答节点、变量映射。

### 概念自检

- [ ] 能用自己的话解释：开始节点、用户输入、知识检索节点、LLM 节点、回答节点、变量映射
...
创建 Chatflow，把用户问题传入知识检索节点，再将检索结果作为上下文交给模型生成回答。
...
可完成一轮带知识上下文的问答；保存流程截图，测试 10 个问题且流程无变量错误。
...
- 分支：`study/day-135`
- 建议提交：`study(day-135): 在-Chatflow-中接入知识检索`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：编写受证据约束的回答提示词](../2027-01-14-Day136-编写受证据约束的回答提示词/README.md)
