...
# 2026-10-17 · Day 047 · 图片输入与预览

[全年索引](../../../README.md) · [分类索引](../../README.md) · [月度原计划](../../../../02-第2月-AI交互体验.md)

[上一天：上传进度、取消与重试](../2026-10-16-Day046-上传进度-取消与重试/README.md) · [下一天：附件与消息上下文绑定](../2026-10-18-Day048-附件与消息上下文绑定/README.md)

## 今日定位

- **日期**：2026-10-17（星期六）
- **阶段**：第 2 月 / 模块内第 17 天 / 全年第 47 天
- **分类**：AI交互与多模态
- **难度**：入门
- **原计划时间**：2 小时。
...
图片尺寸、压缩、EXIF 方向、Object URL 清理、相册/相机权限提示。

### 概念自检

- [ ] 能用自己的话解释：图片尺寸、压缩、EXIF 方向、Object URL 清理、相册/相机权限提示
...
实现图片缩略图、全屏预览、删除和发送；可选做客户端压缩；移动端验证相册选择，相机入口可先保留接口。
...
图片方向正确，发送前后都可预览；删除或组件卸载后释放临时 URL；大图不会卡死界面。
...
- 分支：`study/day-047`
- 建议提交：`study(day-047): 图片输入与预览`
- 提交内容应包括：代码或配置、必要测试、当天笔记、验收证据索引。

## 下一步

[下一天：附件与消息上下文绑定](../2026-10-18-Day048-附件与消息上下文绑定/README.md)
